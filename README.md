...
# Optional
SUPABASE_TABLE=bazaraki_rent_apartments
```

On Apify, add these as Secrets/Environment variables in your Actor settings.

### Supabase migration

Run this SQL in your Supabase project to create the target table:

File: `supabase/migrations/0001_create_bazaraki_rent_apartments.sql`

It creates the `public.bazaraki_rent_apartments` table with fields for URL, title, price text, attributes JSON, description, common numeric fields, image URLs, and timestamps, plus an `updated_at` trigger.
